    ...
    render() {
        return (
            <div>
                            ...
                            <div>
                                        <h3>COLABORADOR </h3>
                                            <p> Datos requeridos son Nombre Completo, Correo electronico Y contraseña.</p>
                                    ...
                                    <div class="uk-grid-item-match">
                                            <div class="uk-card uk-card-default uk-card-body">
                                                ...
                                                <form>
                                                        ...
                                                        <div class="uk-margin">
                                                            <input class="uk-input uk-form-width-medium uk-form-large" type="text" placeholder="E - mail"></input>
                                                        </div>
                      
                                                        <div class="uk-margin">
                                                            <input class="uk-input uk-form-width-medium uk-form-large" type="text" placeholder="Contraseña"></input>
                                                        </div>
                                                </form>
